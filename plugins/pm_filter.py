...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>⚠️ ꜱᴏʀʀʏ ɪ ᴀᴍ ɴᴏᴛ ᴡᴏʀᴋɪɴɢ ɪɴ ᴘᴍ. ꜱᴇᴀʀᴄʜ ᴍᴏᴠɪᴇꜱ ʜᴇʀᴇ - @The_MoviesRequest1</b>")
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/ROHANKUMARJENA")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
